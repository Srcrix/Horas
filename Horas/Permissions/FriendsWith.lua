...
function FriendsWith:checkPermission(player: Player, ...): boolean | nil
	local args = { ... }
	
	if not args[1] then
		return nil, "No player ID provided"
	end
